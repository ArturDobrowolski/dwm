...
#define DWMUTIL(prog, arg)      { .v = (const char*[]){ prog, arg } }
...
static const Key keys[] = {
        ...
        { MODKEY,               XK_e,           spawn,          STCMD("$FILE_EXPLORER") },
        { MODKEY|ALT,           XK_e,           spawn,          STCMD("$FILE_EXPLORER_ALT0") },
        { MODKEY|ShiftMask,     XK_e,           spawn,          STCMD("$FILE_EXPLORER_ALT1") },
        ...
        /* dwmutils */
        { NOKEY,                XK_Print,       spawn,          DWMUTIL("screenshot", "selection") }, 
        { MODKEY,               XK_Print,       spawn,          DWMUTIL("screenshot", "window") }, 
        { MODKEY|ShiftMask,     XK_Print,       spawn,          DWMUTIL("screenshot", "all") }, 
        { MODKEY,               XK_a,           spawn,          DWMUTIL("amilauncher", NULL) },
        { MODKEY,               XK_z,           spawn,          DWMUTIL("xclipemoji", NULL) },
        { MODKEY,               XK_p,           spawn,          DWMUTIL("xclippass", NULL) },
        { MODKEY,               XK_b,           spawn,          DWMUTIL("btconn", NULL) },
...
static const Button buttons[] = {
        ...
        { ClkLtSymbol,          NOKEY,                  Button1,        setlayout,      {0} },
        { ClkLtSymbol,          NOKEY,                  Button3,        setlayout,      {.v = &layouts[2]} },
        { ClkWinTitle,          NOKEY,                  Button2,        zoom,           {0} },
        { ClkStatusText,        NOKEY,                  Button2,        spawn,          {.v = termcmd } },
        { ClkClientWin,         MODKEY,                 Button1,        movemouse,      {0} },
        { ClkClientWin,         MODKEY,                 Button2,        togglefloating, {0} },
        { ClkClientWin,         MODKEY,                 Button3,        resizemouse,    {0} },
        { ClkClientWin,         MODKEY|ShiftMask,       Button1,        swalmouse,      {0} },
        { ClkTagBar,            NOKEY,                  Button1,        view,           {0} },
        { ClkTagBar,            NOKEY,                  Button3,        toggleview,     {0} },
